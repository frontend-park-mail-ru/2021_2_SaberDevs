 ...
 * 
 * @isRegistered {boolean} true, если нужно отобразить форму для входа, false - для регистрации
 * @onLogin {callback} действие, которое будет выполнено после успешного входа/регистрации
 */
...
export default function signupPage(props) {  
    ...
    changeFormTypeBtn.textContent = props.isRegistered ? "Создать аккаунт" : "У меня уже есть аккаунт";
