...
const cacheUrls = [
  ...
  './static/styles/blocks/_feed.scss',
  ...
  './static/styles/blocks/_settings.scss',
  ...
  './components/authButtons.pug.js',
  './components/buttonNav.pug.js',
  './components/buttonsLoginRegister.pug.js',
  './components/buttonToMenu.js',
  './components/card.pug.js',
  './components/card_copy.pug.js',
  './components/feed.pug.js',
  './components/formRow.pug.js',
  './components/formSettingsRow.pug.js',
  './components/formSettingsTextarea.pug.js',
  './components/header.pug.js',
  './components/index.pug.js',
  './components/linksController.js',
  './components/login.pug.js',
  './components/modal.pug.js',
  './components/modalDefault.pug.js',
  './components/news.pug.js',
  './components/newsBar.pug.js',
  './components/popup.pug.js',
  './components/preview.pug.js',
  './components/profile.pug.js',
  './components/registration.pug.js',
  './components/router.js',
  './components/settings.pug.js',
  './components/sidebar.pug.js',
  './components/signupModal.js',
  './components/signupModal.pug.js',
  './components/userPreview.pug.js',
  ...
  './components/signupModal/signupModal.pug.js',
